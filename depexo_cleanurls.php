...
class depexo_CleanUrls extends Module
{
    public function __construct()
    {
        $this->name = 'depexo_cleanurls';
        $this->tab = 'seo';
        $this->version = '1.2.3';
        $this->author = 'depexo';
        ...
        $this->displayName = $this->l('depexo Clean URLs');
        $this->description = $this->l('This override-module allows you to remove URL ID\'s.');

        $this->confirmUninstall = $this->l('Are you sure you want to uninstall "depexo Clean URLs" module?');
    }
